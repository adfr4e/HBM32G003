...
{ 
	...
	CLKSRC_LOW16  =  0x03,              // 低16位定时器作为计数时钟
	CLKSRC_HIGH16 =  0x04,              // 高16位定时器作为计数时钟
...
typedef enum
{ 
	BRAKE0_LOW_BRAKE1_LOW    = 0x00,   //刹车0低电平刹车1低电平
	BRAKE0_HIGH_BRAKE1_LOW   = 0x01,   //刹车0高电平刹车1低电平
	BRAKE0_LOW_BRAKE1_HIGH   = 0x02,   //刹车0低电平刹车1高电平
	BRAKE0_HIGH_BRAKE1_HIGH  = 0x03,   //刹车0高电平刹车1高电平
} PWMPLUS_BrakeLevel_TypeDef;

typedef enum
{ 
	BRAKE0_DIS_BRAKE1_DIS    =  0x00,  //刹车0禁能刹车1禁能
	BRAKE0_EN_BRAKE1_DIS     =  0x01,  //刹车0使能刹车1禁能
	BRAKE0_DIS_BRAKE1_EN     =  0x02,  //刹车0禁能刹车1使能
	BRAKE0_EN_BRAKE1_EN      =  0x03,  //刹车0使能刹车1使能
...
typedef struct {
	...
	PWMPLUS_BrakeLevel_TypeDef Brake_InputLevel;   //刹车输入有效电平选择   0  低电平有效  1  高电平有效
	
	uint32_t Trig_Comp;                       //内部触发点
...
void PWMPLUS_SetClkDiv(PWMPLUS_TypeDef * PWMPLUSx,uint8_t ClkDiv);                                                //设置预分频系数   实际分频为配置值加1
...
void PWMPLUS_SetBrake_InputLevel(PWMPLUS_TypeDef * PWMPLUSx,PWMPLUS_BrakeLevel_TypeDef Brake_InputLevel);         //设置刹车输入有效电平选择 

void PWMPLUS_SetBrake_Enable(PWMPLUS_TypeDef * PWMPLUSx,uint8_t CHx,PWMPLUS_BrakeEnable_TypeDef Brake_Enable);    //设置刹车使能
...
void PWMPLUS_SetTrig_Comp(PWMPLUS_TypeDef * PWMPLUSx, uint16_t Trig_Comp);                                        //设置内部触发点
